...
<section class="inner-banner">
    <h1 class="font-weight-bold text-center">Our Blogs</h1>
</section>
<!-- end inner banner -->
<!-- start about us -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                ...
                $sql = "SELECT year, h1, p, img FROM blogs LIMIT 1";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<h5 class='font-weight-bold text-uppercase mb-3' data-aos='fade-up' data-aos-duration='1000'>My blogs</h5>";
                    echo "<h1>$h1</h1>";
                    echo "<p>$p</p>";
                }
            ...
            <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-0">
                <div class="about-img">
                    ...
                    <div class="img_2 d-flex" data-aos="zoom-in" data-aos-duration="1000">
                        <h5 class="mb-0 text-white">Recent Blogs</h5>
