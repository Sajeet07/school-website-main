                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $sn; ?></td>
                                            <td>
                                                <a name="" id="" class="btn btn-primary btn-xs" href="editnotice.php?id=<?php echo $data['id']; ?>" role="button">Edit</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form id="deleteForm" action="process/deletenotice.php" method="POST">
