                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $sn; ?></td>
                                            <td>
                                                <a name="" id="" class="btn btn-primary btn-xs" href="editblog.php?id=<?php echo $data['id']; ?>" role="button">Edit</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="deleteModalLabel">Delete Blogs</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                <form id="deleteForm" action="process/deleteblog.php" method="POST">
