            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <form action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  <label for="">Site_key<span style="color:red;">*</span></label>
                                  <input type="text"class="form-control" name="site_key" id="" value="<?php echo $site_key; ?>" aria-describedby="helpId" placeholder="" required>
                                </div>

                                <div class="form-group">
                                  <label for="">Site_value<span style="color:red;">*</span></label>
